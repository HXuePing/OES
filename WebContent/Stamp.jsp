...
<table class="table table-hover table-striped">
	...
	<c:forEach items="${stuList}" var="post" varStatus="i">
	<tr><td>${ Name.examSubjectName}</td><td>${ post.examUserId}</td><td>${examUser[i.count-1].examUserName}</td><td>${ post.examGradeTime}</td><td>${post.examGradePoint}</td><tr>
	</c:forEach></table>
