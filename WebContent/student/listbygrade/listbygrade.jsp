...
<body class="theme-blue">
  ...
  <!-- 顶部横幅 -->
    ...
    <li><ul class="dashboard-menu nav nav-list collapse in">      
    		<li ><a href="${ pageContext.request.contextPath }/student/listPage"><span class="fa fa-caret-right"></span>学员进行考试</a></li>      
            <li ><a href="${ pageContext.request.contextPath }/student/listBydone"><span class="fa fa-caret-right"></span>学员查看科目列表</a></li>
            <li ><a href="${ pageContext.request.contextPath }/student/listNodone"><span class="fa fa-caret-right"></span>学员查看成绩</a></li>
    </ul></li>
	...
	<tr>
	<td>姓名</td><td>${stu.examUserName }</td>
	<td>科目</td><td>${es.examSubjectName}</td>
	</tr>
	<tr>
	<td>成绩等级</td><td>${grade.examGradePoint }</td>
	<td>正确的题数</td><td>${grade.examGradeRight}</td>
	</tr>
	<tr>
	<td>成绩总分</td><td>${grade.examGradeSum}</td>
	<td>完成时间</td><td>${date}</td>
	</tr>
	<tr>
	<td>成绩flag</td><td>${grade.examGradeFlag}</td>
	<td></td><td></td>
	</tr>
		...
		<div style="text-align: center;">
		 <button id="table1" class="btn btn-primary"   onclick="Print()">
   	打印
		</button> 	
		</div>	
